...
print_userinfo3('xiaoming', 18, 170, 'xiaohong', height=170)
...
res = map(group, ids, names, salary)
print(list(res))
...
res = map(lambda x: x.capitalize(), users)
...
def selection_sort(seq=None):
    ...
    for i in range(0, n - 1):
        ...
        if seq[smallest_index] < seq[i]:
            seq[smallest_index], seq[i] = seq[i], seq[smallest_index]
